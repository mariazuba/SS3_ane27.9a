...
#---------------------------------------------------------------------------------------
#_Bmark_years: 
            #  beg_bio, end_bio, beg_selex, end_selex, beg_relF, end_relF, beg_recr_dist, 
            #  end_recr_dist, beg_SRparm, end_SRparm (enter actual year, 
...
#---------------------------------------------------------------------------------------
#_Fcast_years:  
#            beg_selex, end_selex, beg_relF, end_relF, beg_recruits, end_recruits  
...
#---------------------------------------------------------------------------------------
# Control rule method 
   # (1=catch=f(SSB) west coast; 
   # 2=F=f(SSB) ) 
fore1$ControlRuleMethod<-1
#---------------------------------------------------------------------------------------
# Control rule Biomass level for constant F 
# (as frac of Bzero, e.g. 0.40); (Must be > the no F level below) 
fore1$BforconstantF<-0.6
#---------------------------------------------------------------------------------------
# Control rule Biomass level for no F 
...
#---------------------------------------------------------------------------------------
#_Forecast loop control #3 (reserved for future bells&whistles) 
fore1$fcast_rec_option<- -1
#---------------------------------------------------------------------------------------
#_Forecast loop control #4 (reserved for future bells&whistles) 
...
fore1$FirstYear_for_caps_and_allocations<-2022
#---------------------------------------------------------------------------------------
...
fore1$Yinit<-2019
#---------------------------------------------------------------------------------------
# fleet relative F:  1=use first-last alloc year; 2=read seas, fleet, alloc list below
...
allocation<-data.frame(Year=2022,Group1=1)
